...
namespace LogAll
{
    public static class WebHelper
    {
            ...
            HttpContext context, Dictionary<string, object> diagnosticInfo = null)
        {
            ...
            FullLogger.WriteDiagnostic(details);
        }
            ...
            HttpContext context)
        {
            ...
            FullLogger.WriteError(details);
        }

        public static LogDetails GetWebFlogDetail(string product, string layer,
